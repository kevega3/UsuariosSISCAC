...
<div class="row">
                        ...
                        <div class="col-50 1 ">
                            ...
                            <label class="file">
                                <input type="file" id="files" onclick="validarTamano()" onchange="validar()"
                                    name="asignacionUsuarios" accept=".xlsx,.xls" >
                    ...
                    <div class="text2 ">
                        ...
                        <div class="col-50 0">
                            <label for="filePDF2">Formato de Tratamiento de datos personales Funcionarios</label>
                            <label class="file">
                                <input type="file" id="filePDF2" onclick="validarTamanoPDF2()" onchange="validarPDF2()"
                                    accept=".pdf" name="funcionarios">
                                <span class="file-custom"><a id="file4"><?php echo $Nombre[3] ?></a></span>
                            </label>
                        </div>
                    </div>
    <br>
