        ...
        <div class="Container-Tables">
            <div class="BordeTabla">
                <table id="Tablas" class="table table-striped" style="width:100%">
                    ...
                    $query ="SELECT DISTINCT s.IdSolicitud, t.DescripcionEntidad,s.NIT,s.NumVNIT,s.Nombre,s.RepresentanteLegal,s.Cargo,s.Correo,s.Telefono,s.FechaCreacion,s.IdEstado FROM solicitudes s INNER JOIN tipoentidad t  ON s.IdTipoEntidad = t.IdTipoEntidad WHERE IdEstado = 2";
